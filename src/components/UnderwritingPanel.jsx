    ...
    return (
        <div className="flex flex-col h-full bg-slate-900 border-l border-slate-700 shadow-2xl animate-in slide-in-from-right duration-300">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                {results && (
                    <div className="space-y-4 pt-4 border-t border-slate-800">
                        <div className="bg-gradient-to-br from-emerald-500/20 to-emerald-600/5 rounded-2xl p-5 border border-emerald-500/20">
                            <div className="text-[10px] text-emerald-400 font-black uppercase tracking-widest mb-1">Max Allowable Bid</div>
                            <div className="text-3xl font-black text-white">${Math.round(results.max_allowed_bid).toLocaleString()}</div>
            ...
            <div className="p-6 bg-slate-800/50 border-t border-slate-700">
                <button className="w-full py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-black rounded-xl shadow-lg transition-all active:scale-[0.98]">
        ...
        <div className="space-y-1.5">
            ...
            <div className="relative group">
                ...
                <input 
                    ...
                    className={`w-full bg-slate-800 border border-slate-700 rounded-xl py-3 pl-8 pr-4 text-sm font-bold ${color} outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 group-hover:border-slate-600 transition-all`}
                />
            </div>
        </div>
    );
...
function StatBox({ label, value, sub }) {
    return (
        <div className="bg-slate-800/30 border border-slate-700 rounded-xl p-4">
            ...
            <div className="text-xl font-black text-white my-0.5">{value}</div>
