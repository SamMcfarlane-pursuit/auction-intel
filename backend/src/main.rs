...
static STATE_NAMES: Lazy<HashMap<&str, &str>> = Lazy::new(|| {
    ...
    m.insert("AK", "Alaska");
    m.insert("AZ", "Arizona");
    m.insert("AR", "Arkansas");
    m.insert("CA", "California");
    m.insert("CO", "Colorado");
    m.insert("CT", "Connecticut");
    m.insert("DE", "Delaware");
    m.insert("DC", "District of Columbia");
    m.insert("FL", "Florida");
    m.insert("GA", "Georgia");
    m.insert("HI", "Hawaii");
    m.insert("ID", "Idaho");
    m.insert("IL", "Illinois");
    m.insert("IN", "Indiana");
    m.insert("IA", "Iowa");
    m.insert("KS", "Kansas");
    m.insert("KY", "Kentucky");
    m.insert("LA", "Louisiana");
    m.insert("ME", "Maine");
    m.insert("MD", "Maryland");
    m.insert("MA", "Massachusetts");
    m.insert("MI", "Michigan");
    m.insert("MN", "Minnesota");
    m.insert("MS", "Mississippi");
    m.insert("MO", "Missouri");
    m.insert("MT", "Montana");
    m.insert("NE", "Nebraska");
    m.insert("NV", "Nevada");
    m.insert("NH", "New Hampshire");
    m.insert("NJ", "New Jersey");
    m.insert("NM", "New Mexico");
    m.insert("NY", "New York");
    m.insert("NC", "North Carolina");
    m.insert("ND", "North Dakota");
    m.insert("OH", "Ohio");
    m.insert("OK", "Oklahoma");
    m.insert("OR", "Oregon");
    m.insert("PA", "Pennsylvania");
    m.insert("RI", "Rhode Island");
    m.insert("SC", "South Carolina");
    m.insert("SD", "South Dakota");
    m.insert("TN", "Tennessee");
    m.insert("TX", "Texas");
    m.insert("UT", "Utah");
    m.insert("VT", "Vermont");
    m.insert("VA", "Virginia");
    m.insert("WA", "Washington");
    m.insert("WV", "West Virginia");
    m.insert("WI", "Wisconsin");
    m.insert("WY", "Wyoming");
    m
});
...
static STATE_AUCTION_DATA: Lazy<HashMap<String, StateAuctionInfo>> = Lazy::new(|| {
    ...
    add_state!(
        ...
        "12%",
        "3 years",
        "Most sales May-June; 12% interest from date of sale"
    );
    add_state!(
        "AZ",
        "Lien",
        "16%",
        "3 years",
        "Bid-down process; max 16% simple interest"
    );
    add_state!(
        "CO",
        "Lien",
        "Fed rate + 9pts",
        "3 years",
        "Premium bidding; no premium reimbursement"
    );
    add_state!(
        "CT",
        "Lien",
        "18%",
        "6 months",
        "Combined lien/deed format; larger towns only"
    );
    add_state!(
        "DC",
        "Lien",
        "18%",
        "6 months - 1 year",
        "Premium bidding; no interest on overbid"
    );
    add_state!(
        "FL",
        "Lien",
        "18%",
        "2 years",
        "Bid-down; guaranteed 5% minimum return"
    );
    add_state!(
        "GA",
        "Lien",
        "20-40%",
        "1 year",
        "20% year 1; escalates to 30% after 2yrs, 40% after 3yrs"
    );
    add_state!(
        "IL",
        "Lien",
        "18%",
        "2 years",
        "Bid-down from 18%; graduated penalty redemption"
    );
    add_state!(
        "IN",
        "Lien",
        "Graduated",
        "1 year",
        "A/B/C Sales process; Commissioner's Sale for county-titled"
    );
    add_state!(
        "IA",
        "Lien",
        "24%",
        "1 year 9 months",
        "Bid least undivided ownership interest; highest rate"
    );
    add_state!(
        "KY",
        "Lien",
        "12%",
        "1 year",
        "12% interest from date of issuance"
    );
    add_state!(
        "LA",
        "Lien",
        "Bid-down",
        "3 years",
        "2024-2025 reform: bid-down interest system; online now available"
    );
    add_state!(
        "MD",
        "Lien",
        "18-24%",
        "6 months",
        "Statutory 6% but most counties charge 18-24%"
    );
    add_state!(
        "MA",
        "Lien",
        "16%",
        "Collector's deed",
        "Smallest undivided part auction; 16% rate"
    );
    ...
    add_state!(
        ...
        "10%",
        "2 years",
        "10% interest; 18% penalty each year delinquent"
    );
    add_state!(
        "MT",
        "Lien",
        "10%",
        "2-3 years",
        "5/6 of 1% per month (10% per annum)"
    );
    add_state!(
        "NE",
        "Lien",
        "14%",
        "3 years",
        "Undivided interest at 14% per annum"
    );
    add_state!(
        "NH",
        "Lien",
        "18%",
        "2 years",
        "Auction for percentage of undivided interest"
    );
    add_state!(
        "NJ",
        "Lien",
        "18%",
        "2 years",
        "Bid-down from 18%; active market"
    );
    add_state!(
        "OK",
        "Lien",
        "8%",
        "2 years",
        "Multiple bidders decided by random drawing"
    );
    add_state!(
        "RI",
        "Lien",
        "10% + 1%/mo",
        "1 year",
        "Collector's Deed; 10% first 6mo, 1%/mo after"
    );
    add_state!(
        "SC",
        "Lien",
    ...
    add_state!(
        ...
        "15% + 3% penalty",
        "4 years",
        "Longest redemption; 15% + 3% penalty + fees"
    );
    ...
    add_state!(
        ...
        "N/A",
        "1 year",
        "Municipal foreclosure; deeded to borough/city if unredeemed"
    );
    add_state!(
        "AR",
        "Deed",
        "N/A",
        "30 days",
        "Forfeited to state; limited warranty deed after 30 days"
    );
    add_state!(
        "CA",
        "Deed",
        "N/A",
        "5 years (3 for some)",
        "Tax Collector's Deed; free of pre-existing encumbrances"
    );
    add_state!(
        "DE",
        "Deed",
        "15%",
        "60 days",
        "Judicial foreclosure; 15% penalty on redemption"
    );
    add_state!(
        "HI",
        "Deed",
        "N/A",
        "1 year",
        "3-year lien before auction; 1-year redemption after sale"
    );
    add_state!(
        "ID",
        "Deed",
        "N/A",
        "3 years before deed",
        "Tax deed to county after 3 years; then sold at auction"
    );
    add_state!(
        "KS",
        "Deed",
        "N/A",
        "Court judgment",
        "Bid off to county; court petition for foreclosure"
    );
    add_state!(
        "ME",
        "Deed",
        "N/A",
        "18 months",
        "Tax lien mortgage auto-forecloses after 18 months"
    );
    add_state!(
        "MI",
        "Deed",
        "N/A",
        "None after sale",
        "Forfeit lands; auction 3rd Tuesday July; min bid = taxes + FMV"
    );
    add_state!(
        "MN",
        "Deed",
        "N/A",
        "None after sale",
        "Tax-forfeited land auctions; cash or installment"
    );
    add_state!(
        "NV",
        "Deed",
        "N/A",
        "2 years before deed",
        "Tax deed to Treasurer after 2yr; then auction"
    );
    add_state!(
        "NM",
        "Deed",
        "N/A",
        "120 days IRS only",
        "No owner redemption; Quitclaim Deed issued"
    );
    add_state!(
        "NY",
        "Deed",
        "N/A",
        "2-4 years",
        "2yr standard; 3-4yr for residential/farm; judicial foreclosure"
    );
    add_state!(
        "NC",
        "Deed",
        "N/A",
        "Upset bid period",
        "Judicial foreclosure or docketing certificate"
    );
    add_state!(
        "ND",
        "Deed",
        "Max 9%",
        "4 years",
        "Bid-down from 9%; 4yr redemption from due date"
    );
    add_state!(
        "OH",
        "Deed",
        "N/A",
        "None after sale",
        "Judicial foreclosure after 2yr delinquent; Sheriff's sale"
    );
    add_state!(
        "OR",
        "Deed",
        "N/A",
        "2 years before deed",
        "Foreclosure after 3yr; sold to county; 2yr redemption"
    );
    add_state!(
        "PA",
        "Deed",
        "N/A",
        "None after sale",
        "Upset Sale; min bid = taxes + interest + costs"
    );
    add_state!(
        "TN",
        "Deed",
        "N/A",
        "1 year",
        "2yr delinquent before Chancery Court suit"
    );
    add_state!(
        "TX",
        "Deed",
        "25% penalty",
        "6mo-2yr",
        "6mo non-Homestead; 2yr Homestead/Ag; 25% penalty"
    );
    add_state!(
        "UT",
        "Deed",
        "N/A",
        "4 years",
        "Preliminary sale Jan 16; final sale May 4yr later"
    );
    add_state!(
        "VT",
        "Deed",
        "N/A",
        "1 year",
        "Foreclosure after 2yr; Collector's Deed after 1yr redemption"
    );
    add_state!(
        "VA",
        "Deed",
        "N/A",
        "Surplus rights only",
        "Judicial foreclosure; 3yr after due date; surplus to former owner"
    );
    add_state!(
        "WA",
        "Deed",
        "N/A",
        "3 years before sale",
        "Certificate of delinquency after 3yr; foreclosure judgment"
    );
    add_state!(
        "WI",
        "Deed",
        "N/A",
        "2 years",
        "Tax deed after 2yr certificate; county cannot sell certificate"
    );
...
async fn get_census_counties() -> Json<CensusCountiesResponse> {
    ...
    match census::fetch_all_counties(api_key.as_deref()).await {
        Ok(counties) => Json(CensusCountiesResponse {
            updated: chrono::Utc::now().to_rfc3339(),
...
async fn get_state_foreclosures_handler(
...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route(
            "/api/foreclosures/:state",
            get(get_state_foreclosures_handler),
        )
        .route(
            "/api/foreclosures/trends",
            get(get_foreclosure_trends_handler),
        )
